...
fish_tribes = list(
  ...
  "Angling" = c("Black Bass","Bowfin","Burbot","Catfish","Drum","Gar","Paddlefish","Perch","Pike","Salmon/Trout","Sturgeon","Sunfish","White Bass","Whitefish"),
  "Assorted" = c("Cavefish","Eel","Goby","Lamprey","Livebearer", "Madtom", "Mudminnow","Pupfish","Pygmy Sunfish","Sculpin","Shad/Herring",
                 "Silverside","Smelt","Splitfin","Stickleback","Topminnow","Trout-Perch"),
  "Brackish" = c("Anchovy", "Cod", "Flatfish","Ladyfish","Mullet","Pipefish","Stingray","Surfperch"),
  "Exotics" = c("Carp", "Cichlid", "Knifefish", "Loach", "Snakehead", "Tetra"))
